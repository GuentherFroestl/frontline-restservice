 ...
 */
public class TomControl {

	private static TomControl instance = new TomControl();
	...
	static String cxdbHandlerClass = "de.gammadata.tom.four_d_access.dataBase.DB4D68Handler";
	...
	public static TomControl getInstance() {
		return instance;
	}
	...
	public DataBaseSpec getDataBaseSpec() {
		de.gammadata.tom.four_d_access.dataBase.DataBaseSpec dbSpec = new de.gammadata.tom.four_d_access.dataBase.DataBaseSpec();
