 ...
 * aus der 4D Datenbankstruktur Tabelle Nr.: 29 mit dem Namen "Belgungsarten"
 *
 * 
 */
...
public class Belgungsarten extends BasicBean {
	private final boolean printon = true;
	public static final String xmlClassTag = "Belgungsarten";
	...
	public static int belegungsBez_Fn = 11;
	public static int beschreibung_Fn = 12;
	public static int leer_Fn = 13;
	public static int farbcode_Fn = 14;
	...
	private java.lang.String belegungsBez = "";
	...
	"dID", "dL", "dEAM", "dEVON", "dGAM", "dMandant", "dGVON", "dG",
			"dStandort", "dDEL", "belegungsBez", "beschreibung", "leer",
			"farbcode" };
	...
	private static FieldSpec[] fieldSpecs = {
			...
			new FieldSpec("belegungsBez", 11, 40, "java.lang.String", null),
			new FieldSpec("beschreibung", 12, 32768, "java.lang.StringBuilder",
					null),
			new FieldSpec("leer", 13, 2, "java.lang.String", null),
			new FieldSpec("farbcode", 14, 0, "int", null) };

	// generierte Feldkonstanten - Ende

	public Belgungsarten() {
		super();
	}
	...
	public void setBelegungsBez(java.lang.String inp) {
		belegungsBez = inp;
	}

	public java.lang.String getBelegungsBez()
