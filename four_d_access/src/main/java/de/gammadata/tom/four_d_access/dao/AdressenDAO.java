...
public class AdressenDAO extends AbstractDAO<Adressen> {
   ...
   *
   * @param req .getSearchString()
   * @return XmpSelection of Adressen <br/>
   * felder:<br/>
   * Adressen.VORNAME, Adressen.NACHNAME, Adressen.FIRMENNAME, Adressen.FIRMENNAME_2, Adressen.TELEFON, Adressen.HANDY,
   * Adressen.EMAIL, Adressen.EMAIL2, Adressen.STRASSE, Adressen.PLZ, Adressen.ORT <br/>
  ...
  public XmpSelection searchAdressen(SearchByStringRequest req)
    ...
    if (req.isAllrecords()) {
      ...
      if (SearchType.BY_EMAIL.equals(req.getSearchType())) {
        getDbHandler().addQueryPart(
                new QueryPart(new QueryOperant(
        ...
        getDbHandler().addQueryPart(
                ...
                de.gammadata.tom.four_d_access.dbBeans.Adressen.email2_Fn),
                QueryPart.contains, new QueryOperant(req
                .getSearchString())));
        getDbHandler().addQueryPart(
                new QueryPart(QueryPart.booleanOr, new QueryOperant(searchObj,
  ...
  public int[] getCompactFieldSpecs() {
    int[] fieldSpecs = {
      Adressen.dMandant_Fn,
      Adressen.uuid_Fn,
      Adressen.uuid_Fn,
      Adressen.inaktiv_Fn,
      Adressen.vorname_Fn,
      Adressen.nachname_Fn,
      Adressen.titel_Fn,
      Adressen.firmenname_Fn,
      Adressen.abteilung_Fn,
      Adressen.telefon_Fn,
      Adressen.handy_Fn,
      Adressen.eMail_Fn,
      Adressen.adressfeld1_Fn,
      Adressen.pLZ_Fn,
      Adressen.ort_Fn,
      Adressen._040_001_Länder_DID_Fn,
      Adressen.m_040_012_Länder_PostCode_Fn,
      Adressen._068_001_KundenDID_Fn,
      Adressen.m_068_011_KundenNr_Fn
    };
    return fieldSpecs;
  }
}
